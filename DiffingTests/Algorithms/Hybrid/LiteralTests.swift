...
class LiteralTests: DiffingTestCase {
    ...
    // TODO: Lorem lessons: what's important isn't the number of unique ngrams in each string so much as minimizing the number of ngrams shared by a & b. build ngrams until the number stops going down, then backtrack 1?
